...
package com.shixq.contacts.quickcontact;
...
import com.shixq.contacts.ContactSaveService;
import com.shixq.contacts.ContactsActivity;
import com.shixq.contacts.NfcHandler;
import com.shixq.contacts.R;
import com.shixq.contacts.common.CallUtil;
import com.shixq.contacts.common.ClipboardUtils;
import com.shixq.contacts.common.Collapser;
import com.shixq.contacts.common.ContactsUtils;
import com.shixq.contacts.common.activity.RequestPermissionsActivity;
import com.shixq.contacts.common.dialog.CallSubjectDialog;
import com.shixq.contacts.common.editor.SelectAccountDialogFragment;
import com.shixq.contacts.common.interactions.TouchPointManager;
import com.shixq.contacts.common.lettertiles.LetterTileDrawable;
import com.shixq.contacts.common.list.ShortcutIntentBuilder;
import com.shixq.contacts.common.list.ShortcutIntentBuilder.OnShortcutIntentCreatedListener;
import com.shixq.contacts.common.model.AccountTypeManager;
import com.shixq.contacts.common.model.Contact;
import com.shixq.contacts.common.model.ContactLoader;
import com.shixq.contacts.common.model.RawContact;
import com.shixq.contacts.common.model.account.AccountType;
import com.shixq.contacts.common.model.account.AccountWithDataSet;
import com.shixq.contacts.common.model.dataitem.DataItem;
import com.shixq.contacts.common.model.dataitem.DataKind;
import com.shixq.contacts.common.model.dataitem.EmailDataItem;
import com.shixq.contacts.common.model.dataitem.EventDataItem;
import com.shixq.contacts.common.model.dataitem.ImDataItem;
import com.shixq.contacts.common.model.dataitem.NicknameDataItem;
import com.shixq.contacts.common.model.dataitem.NoteDataItem;
import com.shixq.contacts.common.model.dataitem.OrganizationDataItem;
import com.shixq.contacts.common.model.dataitem.PhoneDataItem;
import com.shixq.contacts.common.model.dataitem.RelationDataItem;
import com.shixq.contacts.common.model.dataitem.SipAddressDataItem;
import com.shixq.contacts.common.model.dataitem.StructuredNameDataItem;
import com.shixq.contacts.common.model.dataitem.StructuredPostalDataItem;
import com.shixq.contacts.common.model.dataitem.WebsiteDataItem;
import com.shixq.contacts.common.util.ImplicitIntentsUtil;
import com.shixq.contacts.common.util.DateUtils;
import com.shixq.contacts.common.util.MaterialColorMapUtils;
import com.shixq.contacts.common.util.MaterialColorMapUtils.MaterialPalette;
import com.shixq.contacts.common.util.UriUtils;
import com.shixq.contacts.common.util.ViewUtil;
import com.shixq.contacts.detail.ContactDisplayUtils;
import com.shixq.contacts.editor.ContactEditorFragment;
import com.shixq.contacts.editor.EditorIntents;
import com.shixq.contacts.interactions.CalendarInteractionsLoader;
import com.shixq.contacts.interactions.CallLogInteractionsLoader;
import com.shixq.contacts.interactions.ContactDeletionInteraction;
import com.shixq.contacts.interactions.ContactInteraction;
import com.shixq.contacts.interactions.SmsInteractionsLoader;
import com.shixq.contacts.quickcontact.ExpandingEntryCardView.Entry;
import com.shixq.contacts.quickcontact.ExpandingEntryCardView.EntryContextMenuInfo;
import com.shixq.contacts.quickcontact.ExpandingEntryCardView.EntryTag;
import com.shixq.contacts.quickcontact.ExpandingEntryCardView.ExpandingEntryCardViewListener;
import com.shixq.contacts.quickcontact.WebAddress.ParseException;
import com.shixq.contacts.util.ImageViewDrawableSetter;
import com.shixq.contacts.util.PhoneCapabilityTester;
import com.shixq.contacts.util.SchedulingUtils;
import com.shixq.contacts.util.StructuredPostalUtils;
import com.shixq.contacts.widget.MultiShrinkScroller;
import com.shixq.contacts.widget.MultiShrinkScroller.MultiShrinkScrollerListener;
import com.shixq.contacts.widget.QuickContactImageView;
import com.shixq.contactsbind.HelpUtils;
