...
import com.shixq.contacts.datepicker.DatePicker;
import com.shixq.contacts.datepicker.DatePickerDialog;
...
public class EventFieldEditorView extends LabeledEditorView {
    ...
    private void rebuildDateView() {
        final AccountType.EditField editField = getKind().fieldList.get(0);
