...
import com.shixq.contacts.util.DialogManager.DialogShowingView;
...
public abstract class LabeledEditorView extends LinearLayout implements Editor, DialogShowingView {
    ...
    /**
     * Build the current label state based on selected {@link AccountType.EditType} and
        ...
        builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (ContactsUtils.isGraphic(customText)) {
                    final List<AccountType.EditType> allTypes =
