...
package com.shixq.contacts.activities;
...
import com.shixq.contacts.common.dialog.ClearFrequentsDialog;
import com.shixq.contacts.common.util.ImplicitIntentsUtil;
import com.shixq.contacts.common.widget.FloatingActionButtonController;
import com.shixq.contacts.editor.EditorIntents;
import com.shixq.contacts.interactions.ContactDeletionInteraction;
import com.shixq.contacts.common.interactions.ImportExportDialogFragment;
import com.shixq.contacts.common.list.ContactEntryListFragment;
import com.shixq.contacts.common.list.ContactListFilter;
import com.shixq.contacts.common.list.ContactListFilterController;
import com.shixq.contacts.interactions.ContactMultiDeletionInteraction;
import com.shixq.contacts.interactions.JoinContactsDialogFragment;
import com.shixq.contacts.list.MultiSelectContactsListFragment;
import com.shixq.contacts.list.MultiSelectContactsListFragment.OnCheckBoxListActionListener;
import com.shixq.contacts.list.ContactTileListFragment;
import com.shixq.contacts.list.ContactsIntentResolver;
import com.shixq.contacts.list.ContactsRequest;
import com.shixq.contacts.list.ContactsUnavailableFragment;
import com.shixq.contacts.common.list.DirectoryListLoader;
import com.shixq.contacts.common.preference.DisplayOptionsPreferenceFragment;
import com.shixq.contacts.list.OnContactBrowserActionListener;
import com.shixq.contacts.list.OnContactsUnavailableActionListener;
import com.shixq.contacts.list.ProviderStatusWatcher;
import com.shixq.contacts.common.list.ViewPagerTabs;
import com.shixq.contacts.preference.ContactsPreferenceActivity;
import com.shixq.contacts.common.util.AccountFilterUtil;
import com.shixq.contacts.common.util.ViewUtil;
import com.shixq.contacts.quickcontact.QuickContactActivity;
import com.shixq.contacts.util.AccountPromptUtils;
import com.shixq.contacts.common.util.Constants;
import com.shixq.contacts.util.DialogManager;
import com.shixq.contactsbind.HelpUtils;
import com.shixq.contacts.common.list.ContactTileAdapter;
...
public class PeopleActivity extends ContactsActivity implements
    ...
    private void createViewsAndFragments(Bundle savedState) {
        ...
        mTabTitles[ActionBarAdapter.TabState.FAVORITES] = getString(R.string.favorites_tab_label);
        mTabTitles[ActionBarAdapter.TabState.ALL] = getString(R.string.all_contacts_tab_label);
        ...
        mFavoritesFragment.setDisplayType(ContactTileAdapter.DisplayType.STREQUENT);
    ...
    private class TabPagerAdapter extends PagerAdapter {
        ...
        @Override
        public int getCount() {
            return mAreTabsHiddenInTabPager ? 1 : ActionBarAdapter.TabState.COUNT;
        }
        ...
        public int getItemPosition(Object object) {
            if (mAreTabsHiddenInTabPager) {
                ...
                if (object == mFavoritesFragment) {
                    return getTabPositionForTextDirection(ActionBarAdapter.TabState.FAVORITES);
                }
                if (object == mAllFragment) {
                    return getTabPositionForTextDirection(ActionBarAdapter.TabState.ALL);
                }
            }
