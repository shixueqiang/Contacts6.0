...
package com.shixq.contacts.common.interactions;
...
import com.shixq.contacts.common.util.AccountSelectionUtil;
import com.shixq.contacts.common.util.ImplicitIntentsUtil;
import com.shixq.contacts.common.vcard.ExportVCardActivity;
import com.shixq.contacts.common.vcard.VCardCommonArguments;
import com.shixq.contacts.commonbind.analytics.AnalyticsUtil;
    ...
    private boolean handleImportRequest(int resId, int subscriptionId) {
        ...
        if (size > 1) {
            ...
            SelectAccountDialogFragment.show(
                    ...
                    AccountsListAdapter.AccountListFilter.ACCOUNTS_CONTACT_WRITABLE, args);
