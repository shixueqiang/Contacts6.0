...
package com.shixq.contacts.common.list;
...
import com.shixq.contacts.common.ContactPresenceIconUtil;
import com.shixq.contacts.common.ContactStatusUtil;
import com.shixq.contacts.common.format.TextHighlighter;
import com.shixq.contacts.common.util.ContactDisplayUtils;
import com.shixq.contacts.common.util.SearchUtil;
...
public class ContactListItemView extends ViewGroup
    ...
    public ContactListItemView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, com.shixq.contacts.common.R.styleable.ContactListItemView);
        mPreferredHeight = a.getDimensionPixelSize(
                com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_height, mPreferredHeight);
        mActivatedBackgroundDrawable = a.getDrawable(
                com.shixq.contacts.common.R.styleable.ContactListItemView_activated_background);

        mGapBetweenImageAndText = a.getDimensionPixelOffset(
                com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_gap_between_image_and_text,
                mGapBetweenImageAndText);
        mGapBetweenLabelAndData = a.getDimensionPixelOffset(
                com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_gap_between_label_and_data,
                mGapBetweenLabelAndData);
        mPresenceIconMargin = a.getDimensionPixelOffset(
                com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_presence_icon_margin,
                mPresenceIconMargin);
        mPresenceIconSize = a.getDimensionPixelOffset(
                com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_presence_icon_size, mPresenceIconSize);
        mDefaultPhotoViewSize = a.getDimensionPixelOffset(
                com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_photo_size, mDefaultPhotoViewSize);
        mTextIndent = a.getDimensionPixelOffset(
                com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_text_indent, mTextIndent);
        mTextOffsetTop = a.getDimensionPixelOffset(
                com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_text_offset_top, mTextOffsetTop);
        mDataViewWidthWeight = a.getInteger(
                com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_data_width_weight, mDataViewWidthWeight);
        mLabelViewWidthWeight = a.getInteger(
                com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_label_width_weight,
                mLabelViewWidthWeight);
        mNameTextViewTextColor = a.getColor(
                com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_name_text_color, mNameTextViewTextColor);
        mNameTextViewTextSize = (int) a.getDimension(
                com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_name_text_size,
                (int) getResources().getDimension(com.shixq.contacts.common.R.dimen.contact_browser_list_item_text_size));

        setPaddingRelative(
                a.getDimensionPixelOffset(
                        com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_padding_left, 0),
                a.getDimensionPixelOffset(
                        com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_padding_top, 0),
                a.getDimensionPixelOffset(
                        com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_padding_right, 0),
                a.getDimensionPixelOffset(
                        com.shixq.contacts.common.R.styleable.ContactListItemView_list_item_padding_bottom, 0));

        mTextHighlighter = new TextHighlighter(Typeface.BOLD);

        a.recycle();

        a = getContext().obtainStyledAttributes(com.shixq.contacts.common.R.styleable.Theme);
        mSecondaryTextColor = a.getColorStateList(com.shixq.contacts.common.R.styleable.Theme_android_textColorSecondary);
        a.recycle();

        mHeaderWidth =
                getResources().getDimensionPixelSize(com.shixq.contacts.common.R.dimen.contact_list_section_header_width);
    ...
    public void setSectionHeader(String title) {
        if (!TextUtils.isEmpty(title)) {
            if (mHeaderTextView == null) {
                ...
                mHeaderTextView.setTextAppearance(getContext(), com.shixq.contacts.common.R.style.SectionHeaderStyle);
        ...
        if (mQuickContact == null) {
            ...
            if (mNameTextView != null) {
                mQuickContact.setContentDescription(getContext().getString(
                        com.shixq.contacts.common.R.string.description_quick_contact_for, mNameTextView.getText()));
            }
    ...
    public TextView getNameTextView() {
        if (mNameTextView == null) {
            ...
            mNameTextView.setId(com.shixq.contacts.common.R.id.cliv_name_textview);
    ...
    public TextView getPhoneticNameTextView() {
        if (mPhoneticNameTextView == null) {
            ...
            mPhoneticNameTextView.setId(com.shixq.contacts.common.R.id.cliv_phoneticname_textview);
    ...
    public TextView getLabelView() {
        if (mLabelView == null) {
            ...
            mLabelView.setTextAppearance(getContext(), com.shixq.contacts.common.R.style.TextAppearanceSmall);
            if (mPhotoPosition == PhotoPosition.LEFT) {
            ...
            mLabelView.setId(com.shixq.contacts.common.R.id.cliv_label_textview);
            addView(mLabelView);
        }
        return mLabelView;
    }
    ...
    public TextView getDataView() {
        if (mDataView == null) {
            ...
            mDataView.setTextAppearance(getContext(), com.shixq.contacts.common.R.style.TextAppearanceSmall);
            mDataView.setTextAlignment(View.TEXT_ALIGNMENT_VIEW_START);
            mDataView.setActivated(isActivated());
            mDataView.setId(com.shixq.contacts.common.R.id.cliv_data_view);
    ...
    private String updateSnippet(String snippet, String query, String displayName) {
        ...
        if (matched != null && matched.line != null) {
            ...
            final int lengthThreshold = getResources().getInteger(
                    com.shixq.contacts.common.R.integer.snippet_length_before_tokenize);
    ...
    public void setDrawableResource(int drawableId) {
        ...
        photo.setImageTintList(ColorStateList.valueOf(
                getContext().getColor(com.shixq.contacts.common.R.color.search_shortcut_icon_color)));
    }
