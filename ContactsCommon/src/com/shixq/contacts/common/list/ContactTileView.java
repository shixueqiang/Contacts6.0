...
public abstract class ContactTileView extends FrameLayout {
    ...
    /**
     * Implemented by subclasses to allow them to return a {@link ContactPhotoManager.DefaultImageRequest} with the
     * various image parameters defined to match their own layouts.
     *
     * @param displayName The display name of the contact
     * @param lookupKey The lookup key of the contact
     * @return A {@link ContactPhotoManager.DefaultImageRequest} object with each field configured by the subclass
